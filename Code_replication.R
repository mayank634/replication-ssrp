...
# Source and setting up the modified apsrtable ----
source("code\\apsrtable_new.R")
environment(apsrtable_new) <- asNamespace('apsrtable')
assignInNamespace("apsrtable", apsrtable_new, ns = "apsrtable")

# Load Development Indicators Data
here()
load("data\\devDTA.Rdata")
names(devDTA)
